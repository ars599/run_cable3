...
while [ $yr -le 2001 ]
do
  cp /scratch/p66/ars599/CABLE3/name_luc/s0_cn_cal/cable_${yr}_s0_cn_vcmax_noluc_cal.nml cable_${yr}.nml
  rm restart_out.nc
  rm poolcnp_out.nc
  rm cable_out.nc
  rm STANDARD_*.nc
  rm cnpfluxOut.csv
  mpirun -np 16 ./cable-mpi-vz <cable_${yr}.nml >>test_outnoluc.txt
