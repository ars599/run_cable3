...
cat>/scratch/p66/yxw599/runcable-access-esm/name_luc/s0_cn/cable_${yr}_s0_cn_vcmax_noluc_spin.nml<<EOF
&cable
   filename%met = ''
   ...
   filename%fxpft0 = '/g/data/p66/yxw599/trendy10_input/luc/lucout_access/esm/luclh2_access_0850.nc'
   filename%fxpft = '/g/data/p66/yxw599/trendy10_input/luc/lucout_access/esm/luclh2_access_0851.nc'
   ...
   spincasa = .TRUE.     ! spin casa before running the model if TRUE, and should be set to FALSE if spincasainput 
   ...
   casafile%c2cdumppath= '/scratch/p66/yxw599/runcable-access-esm/trendy10_output/s0_cn_vcmax/'
   ...
   cable_user%casa_spin_startyear=1901
   cable_user%casa_spin_endyear=1910
l_casacnp=.TRUE. 
l_landuse=.FALSE.
icycle=2 
