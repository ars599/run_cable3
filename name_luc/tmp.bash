...
cat>/scratch/p66/yxw599/runcable-access-esm/name_luc/s0_cn_cal/cable_${yr}_s0_cn_vcmax_noluc_cal.nml<<EOF
&cable
   filename%met = ''
   ...
   filename%fxpft0 = '/g/data/p66/yxw599/trendy10_input/luc/lucout_access/esm/luclh2_access_2000.nc'
   filename%fxpft = '/g/data/p66/yxw599/trendy10_input/luc/lucout_access/esm/luclh2_access_2001.nc'
...
l_landuse=.FALSE.
icycle=2 
gswpfile%Rainf  ='/g/data/p66/yh4968/crujra_v10/Rainf/crujra_access_Rainf_${yr}.nc'
gswpfile%snowf='/scratch/p66/yxw599/runcable-access-esm/gswp/system3/cruncep_access_Snowf_${yr}.nc'
gswpfile%LWdown ='/g/data/p66/yh4968/crujra_v10/LWdown/crujra_access_LWdown_${yr}.nc'
gswpfile%SWdown ='/g/data/p66/yh4968/crujra_v10/SWdown/crujra_access_SWdown_${yr}.nc'
gswpfile%PSurf  ='/g/data/p66/yh4968/crujra_v10/PSurf/crujra_access_PSurf_${yr}.nc'
gswpfile%Qair   ='/g/data/p66/yh4968/crujra_v10/Qair/crujra_access_Qair_${yr}.nc'
gswpfile%Tair   ='/g/data/p66/yh4968/crujra_v10/Tair/crujra_access_Tair_${yr}.nc'
gswpfile%wind   ='/g/data/p66/yh4968/crujra_v10/Wind/crujra_access_Wind_${yr}.nc'
&end
EOF
yr=`expr $yr + 1`
yr1=`expr $yr + 1`
